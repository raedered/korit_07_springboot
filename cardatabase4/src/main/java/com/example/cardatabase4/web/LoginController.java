...
public class LoginController {
    ...
    public LoginController(JwtService jwtService, AuthenticationManager authentiactionManager) {
        this.jwtService = jwtService;
        this.authentiactionManager = authentiactionManager;
    }
    ...
    public ResponseEntity<?> getToken(@RequestBody AccountCredentials credentials) {
        ...
        Authentication auth = authentiactionManager.authenticate(creds);
