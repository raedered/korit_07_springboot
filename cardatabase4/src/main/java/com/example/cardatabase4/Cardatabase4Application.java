...
public class Cardatabase4Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// AppUser 더미 데이터를 추가
		// 저 위에 보시면 Owner의 경우에는 owner1 / owner2 만들어가지고 ownerrepository에 저장햇었습니다.
		userRepository.save(new AppUser("user", "$2a$12$Zhe5trBXP4bhhPQRinU7Pu8NszbB1.y7Zb6F1jBEa0TOYbn8mTPPO", "USER"));
		userRepository.save(new AppUser("admin", "$2a$12$DtAiFItVOctzv0sRjYvbJOjZMT7T.eFUgcLaZ/3W5XPsE1D3W8k5S", "ADMIN"));
	}
}
